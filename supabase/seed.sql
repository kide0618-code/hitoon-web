...
INSERT INTO public.cards (id, artist_id, name, description, card_image_url, song_title, subtitle, frame_template_id, rarity, price, total_supply, current_supply, max_purchase_per_user, is_active) VALUES
  ('c1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Midnight Glow [N]', 'ファースト・シングル「Midnight Glow」のノーマルカード', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600', 'Midnight Glow', 'Digital Single 2026', 'normal-frame-radiant', 'NORMAL', 1500, NULL, 42, NULL, true),
  ('c1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Midnight Glow [R]', 'ファースト・シングル「Midnight Glow」のレアカード', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600', 'Midnight Glow', 'Digital Single 2026', 'rare-frame-sunpillar', 'RARE', 3000, 100, 67, 3, true),
  ('c1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Midnight Glow [SR]', 'ファースト・シングル「Midnight Glow」のスーパーレアカード', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600', 'Midnight Glow', 'Digital Single 2026', 'sr-frame-secret-gold', 'SUPER_RARE', 8000, 30, 12, 1, true),

-- Aurora Nights - 2nd Single (Electric Dreams)
  ('c1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Electric Dreams [N]', 'セカンド・シングル「Electric Dreams」のノーマルカード', 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600', 'Electric Dreams', 'Summer Edition', 'normal-frameless-radiant', 'NORMAL', 1500, NULL, 28, NULL, true),
  ('c1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Electric Dreams [R]', 'セカンド・シングル「Electric Dreams」のレアカード', 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600', 'Electric Dreams', 'Summer Edition', 'rare-frame-radiant', 'RARE', 3500, 80, 45, 3, true),
  ('c1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Electric Dreams [SR]', 'セカンド・シングル「Electric Dreams」のスーパーレアカード', 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600', 'Electric Dreams', 'Summer Edition', 'sr-frame-sunpillar', 'SUPER_RARE', 10000, 20, 8, 1, true),

-- Stellar Echo - Debut Album (Starlight Symphony)
  ('c1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000002', 'Stellar Echo - Starlight Symphony [N]', 'デビューアルバム「Starlight Symphony」のノーマルカード', 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600', 'Starlight Symphony', '1st Album Collection', 'normal-frame-none', 'NORMAL', 1200, NULL, 156, NULL, true),
  ('c1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000002', 'Stellar Echo - Starlight Symphony [R]', 'デビューアルバム「Starlight Symphony」のレアカード', 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600', 'Starlight Symphony', '1st Album Collection', 'rare-frame-secret-gold', 'RARE', 2500, 200, 89, 3, true),
  ('c1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000002', 'Stellar Echo - Starlight Symphony [SR]', 'デビューアルバム「Starlight Symphony」のスーパーレアカード', 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600', 'Starlight Symphony', '1st Album Collection', 'sr-frame-radiant', 'SUPER_RARE', 6000, 50, 23, 1, true),

-- Neon Pulse - Live Tour (Cyber Rebellion)
  ('c1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000003', 'Neon Pulse - Cyber Rebellion [N]', 'ライブツアー2026記念ノーマルカード', 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=600', 'Cyber Rebellion', 'Tour Memorial Card', 'normal-frame-radiant', 'NORMAL', 1800, NULL, 312, NULL, true),
  ('c1000000-0000-0000-0000-000000000011', 'a1000000-0000-0000-0000-000000000003', 'Neon Pulse - Cyber Rebellion [R]', 'ライブツアー2026記念レアカード', 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=600', 'Cyber Rebellion', 'Tour Memorial Card', 'rare-frame-sunpillar', 'RARE', 4000, 150, 98, 3, true),
  ('c1000000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000003', 'Neon Pulse - Cyber Rebellion [SR]', 'ライブツアー2026記念スーパーレアカード', 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=600', 'Cyber Rebellion', 'Tour Memorial Card', 'sr-frame-secret-gold', 'SUPER_RARE', 12000, 30, 15, 1, true),

-- Digital Horizon - Club Edition (Future Bass)
  ('c1000000-0000-0000-0000-000000000013', 'a1000000-0000-0000-0000-000000000005', 'Digital Horizon - Future Bass [N]', 'クラブエディションのノーマルカード', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600', 'Future Bass', 'DJ Set Collection', 'normal-frameless-radiant', 'NORMAL', 1000, NULL, 89, NULL, true),
  ('c1000000-0000-0000-0000-000000000014', 'a1000000-0000-0000-0000-000000000005', 'Digital Horizon - Future Bass [R]', 'クラブエディションのレアカード', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600', 'Future Bass', 'DJ Set Collection', 'rare-frame-radiant', 'RARE', 2000, 300, 134, 3, true),
  ('c1000000-0000-0000-0000-000000000015', 'a1000000-0000-0000-0000-000000000005', 'Digital Horizon - Future Bass [SR]', 'クラブエディションのスーパーレアカード', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600', 'Future Bass', 'DJ Set Collection', 'sr-frame-sunpillar', 'SUPER_RARE', 5000, 100, 42, 1, true);
