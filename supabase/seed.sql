...
INSERT INTO public.cards (id, visual_id, artist_id, name, description, rarity, price, total_supply, current_supply, max_purchase_per_user, is_active) VALUES
  ('c1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Midnight Glow [N]', 'ファースト・シングル「Midnight Glow」のノーマルカード', 'NORMAL', 1500, NULL, 42, NULL, true),
  ('c1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Midnight Glow [R]', 'ファースト・シングル「Midnight Glow」のレアカード', 'RARE', 3000, 100, 67, 3, true),
  ('c1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Midnight Glow [SR]', 'ファースト・シングル「Midnight Glow」のスーパーレアカード', 'SUPER_RARE', 8000, 30, 12, 1, true),

-- Aurora Nights - 2nd Single
  ('c1000000-0000-0000-0000-000000000004', 'e1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Electric Dreams [N]', 'セカンド・シングル「Electric Dreams」のノーマルカード', 'NORMAL', 1500, NULL, 28, NULL, true),
  ('c1000000-0000-0000-0000-000000000005', 'e1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Electric Dreams [R]', 'セカンド・シングル「Electric Dreams」のレアカード', 'RARE', 3500, 80, 45, 3, true),
  ('c1000000-0000-0000-0000-000000000006', 'e1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'Aurora Nights - Electric Dreams [SR]', 'セカンド・シングル「Electric Dreams」のスーパーレアカード', 'SUPER_RARE', 10000, 20, 8, 1, true),

-- Stellar Echo - Debut Album
  ('c1000000-0000-0000-0000-000000000007', 'e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'Stellar Echo - Starlight Symphony [N]', 'デビューアルバム「Starlight Symphony」のノーマルカード', 'NORMAL', 1200, NULL, 156, NULL, true),
  ('c1000000-0000-0000-0000-000000000008', 'e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'Stellar Echo - Starlight Symphony [R]', 'デビューアルバム「Starlight Symphony」のレアカード', 'RARE', 2500, 200, 89, 3, true),
  ('c1000000-0000-0000-0000-000000000009', 'e1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'Stellar Echo - Starlight Symphony [SR]', 'デビューアルバム「Starlight Symphony」のスーパーレアカード', 'SUPER_RARE', 6000, 50, 23, 1, true),

-- Neon Pulse - Live Tour
  ('c1000000-0000-0000-0000-000000000010', 'e1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000003', 'Neon Pulse - Cyber Rebellion [N]', 'ライブツアー2026記念ノーマルカード', 'NORMAL', 1800, NULL, 312, NULL, true),
  ('c1000000-0000-0000-0000-000000000011', 'e1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000003', 'Neon Pulse - Cyber Rebellion [R]', 'ライブツアー2026記念レアカード', 'RARE', 4000, 150, 98, 3, true),
  ('c1000000-0000-0000-0000-000000000012', 'e1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000003', 'Neon Pulse - Cyber Rebellion [SR]', 'ライブツアー2026記念スーパーレアカード', 'SUPER_RARE', 12000, 30, 15, 1, true),

-- Digital Horizon - Club Edition
  ('c1000000-0000-0000-0000-000000000013', 'e1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000005', 'Digital Horizon - Future Bass [N]', 'クラブエディションのノーマルカード', 'NORMAL', 1000, NULL, 89, NULL, true),
  ('c1000000-0000-0000-0000-000000000014', 'e1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000005', 'Digital Horizon - Future Bass [R]', 'クラブエディションのレアカード', 'RARE', 2000, 300, 134, 3, true),
  ('c1000000-0000-0000-0000-000000000015', 'e1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000005', 'Digital Horizon - Future Bass [SR]', 'クラブエディションのスーパーレアカード', 'SUPER_RARE', 5000, 100, 42, 1, true);
