    ...
    <article className="prose prose-invert prose-sm max-w-none">
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            アカウントの譲渡・売買：本サービスのアカウント、または購入したデジタルグッズの閲覧権を、当社の承諾なく第三者に有償・無償を問わず譲渡、貸与、または担保に供する行為。
          </li>
          <li>
            営業妨害：
