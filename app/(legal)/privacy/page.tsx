        ...
        <section className="border-b border-gray-800 pb-6">
          ...
          <ol className="list-inside list-decimal space-y-3">
            ...
            <li>
              ...
              <ol className="ml-6 mt-2 list-inside list-decimal space-y-1 text-gray-400">
                <li>
                  端末情報、IPアドレス、OS情報、ブラウザ情報、Cookie、広告識別子（IDFA/ADID）
                </li>
                <li>
                  本サービス内での行動履歴（閲覧、購入、出品、取引成立の履歴）
                </li>
                <li>
                  位置情報（特定のライブ会場連動特典などを提供する場合）
                </li>
              </ol>
            </li>
          </ol>
